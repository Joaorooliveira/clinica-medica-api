...
import med.voll.clinica_medica_api.domain.medico.Especialidade;
...
class ConsultaControllerTest {
    ...
    @MockBean // 2. Isola o Service para não ir no banco de dados
    ...
    void agendar_cenario1() throws Exception {
        var response = mvc.perform(post("/consultas")
                        .contentType(org.springframework.http.MediaType.APPLICATION_JSON) // Diz que é JSON
                        .content("{}")) // Envia um JSON vazio
